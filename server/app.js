...
const dbURI = process.env.MONGODB_URI || 'mongodb://127.0.0.1/ColorContextAndConnotation';
...
redisClient.connect().then(() => {
  ...
  app.use(session({
    ...
    secret: 'Cavonius', // Private string used as a seed for hashing/creating unique session keys
